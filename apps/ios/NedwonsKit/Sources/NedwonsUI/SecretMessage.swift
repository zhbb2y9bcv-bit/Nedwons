...
// `SecretEngine` docs); it lives in the app target that links NedwonsMLS.

/// Reveal phase, mirroring `mls_ffi.SecretPhase` (kept local so NedwonsUI stays free of the native
