...
final class SecretDemoModel: ObservableObject {
    ...
    func phase(_ secretID: Data) -> NedwonsUI.SecretPhase {
...
public struct SecretDemoView: View {
    ...
    public var body: some View {
        let palette = Nedwons.Palette.forScheme(scheme)
        ZStack {
    ...
    private func header(_ palette: Nedwons.Palette) -> some View {
        HStack {
            Text("Contact")
    ...
    private func messageList(_ palette: Nedwons.Palette) -> some View {
        ScrollView {
    ...
    @ViewBuilder
    private func row(_ item: DemoItem, _ palette: Nedwons.Palette) -> some View {
        switch item.kind {
        case .text(let text):
            Text(text)
    ...
    private func composer(_ palette: Nedwons.Palette) -> some View {
