...
fn kem_mode(kem: HpkeKemType) -> hpke_types::KemAlgorithm {
    match kem {
        ...
        // PQ patch (Nedwons): route the X-Wing hybrid KEM (X25519 + ML-KEM-768, draft-06 code
        // point 0x647a) to the rust-crypto backend, which implements it via RustCrypto `ml-kem`.
        // Upstream 0.5.1 left this arm `unimplemented!()`.
...
impl OpenMlsCrypto for RustCrypto {
    ...
    fn supported_ciphersuites(&self) -> Vec<Ciphersuite> {
        vec![
            ...
            Ciphersuite::MLS_128_DHKEMX25519_CHACHA20POLY1305_SHA256_Ed25519,
            Ciphersuite::MLS_128_DHKEMP256_AES128GCM_SHA256_P256,
            // PQ patch (Nedwons): hybrid post-quantum suite (X-Wing KEM), see kem_mode above.
